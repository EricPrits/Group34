...
/**
 * Created by Eric on 2018-02-11.
 */

public class ParseSpellChecker extends SpellCheckerService {
    private static final String TAG = ParseSpellChecker.class.getSimpleName();
